...
from main import _merge_task_results
...
def test_nonempty_result_merges_per_task():
    ...
    _merge_task_results(state, [{"task-a": {"last_run": "2026-05-14T00:00:00+00:00"}}])
...
def test_new_task_added():
    state: dict = {"tasks": {}}
    _merge_task_results(state, [{"new-task": {"last_run": "2026-05-14T00:00:00+00:00"}}])
...
def test_mixed_empty_and_nonempty():
    ...
    _merge_task_results(state, [{"good": {"last_run": "new"}}, {}, RuntimeError("x")])
