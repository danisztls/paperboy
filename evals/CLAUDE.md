...
```
{source_run, replayed_at, models, call_filter, calls: [{call_type, task, ts, item_id?, item_title?, results: [{model, text, input_tokens, output_tokens, latency_s, reasoning, is_original?, error?}, ...]}]}
```
